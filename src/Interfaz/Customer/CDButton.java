...
public class CDButton extends JButton implements MouseListener {
    public CDButton(String text){
        customizeComponent(text);
    }
    public CDButton(String text, String iconnew){
    ...
    public void customizeComponent(String text) {
        ...
        setForeground(CDIAStyle.CDCOLOR_FONT_DARK);
        setHorizontalAlignment(CDIAStyle.CDALIGNMENT_CENTER);
        setFont(CDIAStyle.CDFONT);
        setBackground(CDIAStyle.CDCOLOR_FONT_LIGHT);
