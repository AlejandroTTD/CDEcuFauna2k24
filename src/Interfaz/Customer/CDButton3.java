...
public class CDButton3 extends JButton implements MouseListener {
    public CDButton3(String text){
        customizeComponent(text);
    }
    public CDButton3(String text, String iconnew){
    ...
    public void customizeComponent(String text) {
        ...
        setFont(CDIAStyle.CDFONT_BOLD3);
