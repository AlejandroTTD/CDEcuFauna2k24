...
public class CDDTOIngestaNativa {
    ...
    public CDDTOIngestaNativa() {
    }

    public CDDTOIngestaNativa(Integer cdRowNum, Integer cdIdCatalogo, Integer cdIdCatalogoTipo, String cdNombre,
