...
public class CDDTOTipoHormiga {
    ...
    public CDDTOTipoHormiga() {
    }

    public CDDTOTipoHormiga(Integer cdRowNum, Integer cdIdCatalogo, Integer cdIdCatalogoTipo, String cdNombre,
